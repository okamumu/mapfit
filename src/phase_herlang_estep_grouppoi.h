#ifndef MAPFIT_PHASE_ERLANG_ESTEP_GROUPPOI_H
#define MAPFIT_PHASE_ERLANG_ESTEP_GROUPPOI_H
...
struct HErlangWorkSpaceGroupPoi {
  ...
  HErlangWorkSpaceGroupPoi(int m, int n) :
