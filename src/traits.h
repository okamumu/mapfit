...
struct S4matrix {
  ...
  S4matrix<T>(const Rcpp::S4& _value) : value(_value) {}
};
...
// template <>
// struct matrix_category<Rcpp::S4> {
//   using type = SparseMatrixT;
// };
...
struct vector_traits<S4matrix<T>> {
  static int size(const S4matrix<T>& v) { return Rcpp::as<Rcpp::NumericVector>(v.value.slot("x")).length(); }
  static const double* value(const S4matrix<T>& v) { return &Rcpp::as<Rcpp::NumericVector>(v.value.slot("x"))[0]; }
  static double* value(S4matrix<T>& v) { return &Rcpp::as<Rcpp::NumericVector>(v.value.slot("x"))[0]; }
  static int inc(const S4matrix<T>& v) { return 1; }
};

template <>
struct dense_matrix_traits<S4matrix<DenseMatrixT>> {
  static int nrow(const S4matrix<DenseMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[0]; }
  static int ncol(const S4matrix<DenseMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[1]; }
  static const double* value(const S4matrix<DenseMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static double* value(S4matrix<DenseMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static int ld(const S4matrix<DenseMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[0]; }
};

template <>
struct csr_matrix_traits<S4matrix<CSRMatrixT>> {
  static int nrow(const S4matrix<CSRMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[0]; }
  static int ncol(const S4matrix<CSRMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[1]; }
  static int nnz(const S4matrix<CSRMatrixT>& m) { return Rcpp::as<Rcpp::NumericVector>(m.value.slot("x")).length(); }
  static int base(const S4matrix<CSRMatrixT>& m) { return 0; }
  static double* value(S4matrix<CSRMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static const double* value(const S4matrix<CSRMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static const int* rowptr(const S4matrix<CSRMatrixT>& m) { return &Rcpp::as<Rcpp::IntegerVector>(m.value.slot("p"))[0]; }
  static const int* colind(const S4matrix<CSRMatrixT>& m) { return &Rcpp::as<Rcpp::IntegerVector>(m.value.slot("j"))[0]; }
};

template <>
struct csc_matrix_traits<S4matrix<CSCMatrixT>> {
  static int nrow(const S4matrix<CSCMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[0]; }
  static int ncol(const S4matrix<CSCMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[1]; }
  static int nnz(const S4matrix<CSCMatrixT>& m) { return Rcpp::as<Rcpp::NumericVector>(m.value.slot("x")).length(); }
  static int base(const S4matrix<CSCMatrixT>& m) { return 0; }
  static double* value(S4matrix<CSCMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static const double* value(const S4matrix<CSCMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static const int* colptr(const S4matrix<CSCMatrixT>& m) { return &Rcpp::as<Rcpp::IntegerVector>(m.value.slot("p"))[0]; }
  static const int* rowind(const S4matrix<CSCMatrixT>& m) { return &Rcpp::as<Rcpp::IntegerVector>(m.value.slot("i"))[0]; }
};

template <>
struct coo_matrix_traits<S4matrix<COOMatrixT>> {
  static int nrow(const S4matrix<COOMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[0]; }
  static int ncol(const S4matrix<COOMatrixT>& m) { return Rcpp::as<Rcpp::IntegerVector>(m.value.slot("Dim"))[1]; }
  static int nnz(const S4matrix<COOMatrixT>& m) { return Rcpp::as<Rcpp::NumericVector>(m.value.slot("x")).length(); }
  static int base(const S4matrix<COOMatrixT>& m) { return 0; }
  static double* value(S4matrix<COOMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static const double* value(const S4matrix<COOMatrixT>& m) { return &Rcpp::as<Rcpp::NumericVector>(m.value.slot("x"))[0]; }
  static const int* rowind(const S4matrix<COOMatrixT>& m) { return &Rcpp::as<Rcpp::IntegerVector>(m.value.slot("i"))[0]; }
  static const int* colind(const S4matrix<COOMatrixT>& m) { return &Rcpp::as<Rcpp::IntegerVector>(m.value.slot("j"))[0]; }
};
